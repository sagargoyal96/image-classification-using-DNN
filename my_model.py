...
def csv_writer(test_answers):
    with open('/home/cse/btech/cs1150247/scratch/answers.csv', 'w') as csvfile:
...
from keras.layers import Conv2D, MaxPooling2D, Flatten, SeparableConv2D, AveragePooling2D

model=Sequential()
model.add(Conv2D(64, kernel_size=(3, 3),activation='relu',input_shape=(28,28,1), padding='same'))
model.add(Conv2D(128, kernel_size=(2, 2),activation='relu',input_shape=(28,28,1), padding='same'))
...
csv_writer(labels)
model.save('/home/cse/btech/cs1150247/scratch/newmodel.h5')
